<template>
  <el-card>
        ...
        <div class="card-search">
          <el-row :gutter="10">
            ...
            <el-col :span="3" style="display: inline-flex;justify-content: center;align-items: center;cursor: pointer">
              <el-icon style="font-size: 20px;color: skyblue;" @click="refresh">
                <Refresh />
              </el-icon>
            </el-col>
          </el-row>
    ...
    <el-pagination background layout="total,sizes,prev,pager,next,jumper" :total="total" v-model:page-size="pageSize"
      :page-sizes="[5, 10, 15, 20, 25]" @current-change="changePage" />
